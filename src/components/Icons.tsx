...
// A small, consistent stroke-icon set (24x24 viewBox, round caps/joins) used
// throughout the app instead of emoji - matches the original Settings gear.
...
export function BookIcon({ size = 20 }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M2 4.5h6a3.5 3.5 0 0 1 3.5 3.5v13A2.5 2.5 0 0 0 9 18.5H2z" />
      <path d="M22 4.5h-6A3.5 3.5 0 0 0 12.5 8v13A2.5 2.5 0 0 1 15 18.5h7z" />
    </svg>
  );
}
...
export function LayersIcon({ size = 20 }: IconProps) {
  return (
    ...
    >
      ...
      <polyline points="2 16.5 12 22 22 16.5" />
...
export function CardsIcon({ size = 16 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M3 4.5v11A2.5 2.5 0 0 0 5.5 18" />
    </svg>
  );
}
